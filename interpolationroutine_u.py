...
def westernAustraliaGlobal(ds, var_global, T, depth, latmin, latmax, lonmin, lonmax):
    ...
    ds_QoI = ds[var_global].isel(time_counter=T, depthu=depth, x=slice(Lon_loc1, Lon_loc2) , y=slice(Lat_loc1, Lat_loc2))
...
def interpolator_u(ds, ds_local, var_global, var_local, T, depth, latmin, latmax, lonmin, lonmax):
