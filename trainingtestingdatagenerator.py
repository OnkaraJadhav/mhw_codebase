...
def trainingdata(interpolatedlist_SST, interpolatedlist_Salt, interpolatedlist_u, interpolatedlist_v, interpolatedlist_temp, pds_local, pds_local_salt, days, days_testS, days_testE):
    #%% Training data
    """
    ...
    interpolatedlist_u_train = interpolatedlist_u[:days_testS] + interpolatedlist_u[days_testE+1 :days]
    interpolatedlist_v_train = interpolatedlist_v[:days_testS] + interpolatedlist_v[days_testE+1 :days]
    interpolatedlist_temp_train = interpolatedlist_temp[:days_testS] + interpolatedlist_temp[days_testE+1 :days]
    ...
    X_u_global = np.concatenate(interpolatedlist_u_train)
    X_v_global = np.concatenate(interpolatedlist_v_train)
    X_temp_global = np.concatenate(interpolatedlist_temp_train)
    ...
    X_train = np.concatenate((X_sst_global.reshape(-1,1), X_salt_global.reshape(-1,1), X_feature_1.reshape(-1,1)
                              , X_feature_2.reshape(-1,1), X_feature_3.reshape(-1,1), X_feature_4.reshape(-1,1),
                              X_u_global.reshape(-1,1), X_v_global.reshape(-1,1), X_temp_global.reshape(-1,1)), axis =1)
...
def testingdata(interpolatedlist_SST, interpolatedlist_Salt, interpolatedlist_u, interpolatedlist_v, interpolatedlist_temp, pds_local, pds_local_salt, days, days_testS, days_testE):
    ...
    X_u_global_test = np.concatenate(interpolatedlist_u[days_testS:days_testE+1])
    X_v_global_test = np.concatenate(interpolatedlist_v[days_testS:days_testE+1])
    X_temp_global_test = np.concatenate(interpolatedlist_temp[days_testS:days_testE+1])
    ...
    X_test = np.concatenate((X_sst_global_test.reshape(-1,1), X_salt_global_test.reshape(-1,1), X_feature_1_test.reshape(-1,1)
                              , X_feature_2_test.reshape(-1,1), X_feature_3_test.reshape(-1,1), X_feature_4_test.reshape(-1,1),
                              X_u_global_test.reshape(-1,1), X_v_global_test.reshape(-1,1), X_temp_global_test.reshape(-1,1)), axis =1)
