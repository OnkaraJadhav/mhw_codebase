...
# daysrange = np.r_[daysrangeS, daysrangeE]o

X_train, y_train1 = trainingdata(interpolatedlist_SST, interpolatedlist_Salt, pds_local, pds_local_salt, days, days_testS, days_testE)
X_test, y_test1 = testingdata(interpolatedlist_SST, interpolatedlist_Salt, pds_local, pds_local_salt, days, days_testS, days_testE)
...
index = days_testS
y_test = y_test_array[:interpolatedlist_SST[0].shape[0]]
y_pred = y_pred_array[:interpolatedlist_SST[0].shape[0]]
